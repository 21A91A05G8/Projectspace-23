...
router.post("/api/add-stalls-data",upload.single("agreement"),stallInfocontrollers.addStallsInfo);
...
router.post("/api/add-shopsrent-data",upload.single("agreement"),shoprentcontrollers.addShopsrent);
...
router.post("/api/add-stallsrent-data",upload.single("agreement"),stallrentcontrollers.addStallsrent);
