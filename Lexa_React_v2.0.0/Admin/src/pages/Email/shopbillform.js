            ...
            <CardBody  onSubmit={handleSubmit1}>
              ...
              <Row className="mb-3">
                ...
                <div className="col-md-10">
                  <input
                    className="form-control"
                    type="number" name="mobileNumber" onChange={(e)=>setFormdata({...shops,CurrentMeterReading:e.target.value})} required
              ...
              <Row className="mb-3">
                ...
                <div className="col-md-10">
                  <input
                    className="form-control"
                    type="number" name="rentPerMonth" onChange={(e)=>setFormdata({...shops,UnitsConsumed:e.target.value})} required
              ...
              <Row className="mb-3">
                ...
                <div className="col-md-10">
                  <input
                    className="form-control"
                    type="number" name="agreement" onChange={(e)=>setFormdata({...shops,RsUnit:e.target.value})} required
                  />
                </div>
              </Row>
              <Row className="mb-3">
                ...
                <div className="col-md-10">
                  <input
                    className="form-control"
                    type="number" name="agreement" onChange={(e)=>setFormdata({...shops,TotalAmount:e.target.value})} required
                  />
                </div>
              </Row>
              <Row className="mb-3">
                ...
                <div className="col-md-10">
                  <input
                    className="form-control"
                    type="number" name="agreement" onChange={(e)=>setFormdata({...shops,AmountPaidsb:e.target.value})} required
                  />
                </div>
              </Row>
              <Row className="mb-3">
