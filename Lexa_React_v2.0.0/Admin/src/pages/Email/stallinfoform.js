...
const FormElements = (props) => {
  ...
  const handleSubmit1 = (e) =>{
    ...
    console.log(stalls)
    axios.post('http://localhost:5000/api/add-stalls-data',stalls)
    .then((result)=>window.location.href='/stallinfolist')
}
            ...
            <CardBody  onSubmit={handleSubmit1}>
              ...
              <Row className="mb-3">
                ...
                <div className="col-md-10">
                  <input
                    className="form-control"
                    type="file" name="stallagreement" onChange={(e)=>setFormdata({...stalls,stallagreement:e.target.value})} required
                  />
                </div>
              </Row>
